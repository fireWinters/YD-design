...
var TabHeaderTitle = function (_a, ref) {
    ...
    return render(React.createElement("div", { ref: ref, key: tabKey, className: cs(prefixCls + "-header-title", (_b = {},
            ...
            if (disabled)
                return;
            onClickTab(e);
        }, role: "tab", "aria-selected": isActive, tabIndex: disabled ? -1 : 0, "aria-disabled": disabled || undefined, id: getIdPrefix(index).tab, "aria-controls": getIdPrefix(index).tabpane },
