 ...
 * @title Layout
 */
export interface LayoutProps extends Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, 'className' | 'ref'> {
    style?: CSSProperties;
 ...
 * @title Layout.Header
 */
export interface HeaderProps extends Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, 'className' | 'ref'> {
    className?: string | string[];
}
/**
 * @title Layout.Footer
 */
export interface FooterProps extends Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, 'className' | 'ref'> {
    className?: string | string[];
}
/**
 * @title Layout.Content
 */
export interface ContentProps extends Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, 'className' | 'ref'> {
    className?: string | string[];
}
/**
 * @title Layout.Sider
