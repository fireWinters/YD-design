...
function Pager(props) {
    ...
    return (React.createElement("li", __assign({ style: style, className: classnames, onClick: onClick, "aria-label": (_a = locale.Pagination.currentPage) === null || _a === void 0 ? void 0 : _a.replace('{0}', pageNum) }, ariaCurrentProps), itemRender ? itemRender(pageNum, 'page', pageNum) : pageNum));
}
...
export var StepPager = function (props) {
    ...
    return (React.createElement("li", { style: pageItemStyle, className: cls, onClick: onClick, "aria-label": locale.Pagination[pageType] }, itemRender ? itemRender(undefined, pageType, StepIcon) : StepIcon));
};
