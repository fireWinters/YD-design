...
declare type TransferListTitle = string | ((params: {
    countTotal: number;
...
export interface TransferListProps extends Pick<TransferProps, 'prefixCls' | 'style' | 'className' | 'dataSource' | 'searchPlaceholder' | 'disabled' | 'draggable' | 'showSearch' | 'showFooter' | 'pagination' | 'render' | 'filterOption' | 'onSearch' | 'onResetData' | 'onDragStart' | 'onDragEnd' | 'onDragLeave' | 'onDragOver' | 'onDrop'> {
...
export interface TransferCustomListProps extends Pick<TransferListProps, 'disabled' | 'listType' | 'selectedKeys' | 'validKeys' | 'selectedDisabledKeys'> {
...
export interface TransferItemProps extends Pick<TransferListProps, 'prefixCls' | 'className' | 'render' | 'disabled' | 'draggable' | 'allowClear' | 'selectedKeys' | 'onDragStart' | 'onDragEnd' | 'onDragLeave' | 'onDragOver'> {
    item: TransferItem;
    droppable: boolean;
    onItemSelect: (key: string, selected: boolean) => void;
    onItemRemove: (key: string) => void;
