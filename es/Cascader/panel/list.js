...
var ListPanel = function (props) {
    var _a;
    var _b = __read(useRefs(), 2), activeOptionList = _b[0], setActiveOptionList = _b[1];
    var _c = __read(useRefs(), 2), refWrapper = _c[0], setRefWrapper = _c[1];
    var forceUpdate = useForceUpdate();
    var store = props.store, prefixCls = props.prefixCls, value = props.value, multiple = props.multiple, renderFooter = props.renderFooter, renderOption = props.renderOption, showEmptyChildren = props.showEmptyChildren, loadMore = props.loadMore, renderEmpty = props.renderEmpty;
    var _d = __read(useState(store.findNodeByValue(value && value[value.length - 1]) || null), 2), activeNode = _d[0], setActiveNode = _d[1];
    ...
    useEffect(function () {
        if (props.popupVisible && options.length) {
            var scrollTo_1 = function () {
                activeOptionList.forEach(function (activeOption, i) {
                    activeOption &&
        ...
        return list.length === 0 && !showEmptyChildren ? null : (React.createElement(CSSTransition, { key: level, timeout: {
            ...
            React.createElement("div", { className: cs(prefixCls + "-list-column", (_a = {},
                ...
                list.length === 0 ? (renderEmpty && renderEmpty(props.virtualListProps ? '100%' : 120)) : (React.createElement(VirtualList, __assign({ needFiller: false, threshold: props.virtualListProps ? 100 : null, data: list, isStaticItemHeight: true, itemKey: "value" }, (isObject(props.virtualListProps) ? props.virtualListProps : {}), { wrapper: "ul", role: "menu", ref: function (node) { return setRefWrapper(node === null || node === void 0 ? void 0 : node.dom, level); }, className: cs(prefixCls + "-list", prefixCls + "-list-select", (_c = {},
                    ...
                    return (React.createElement("li", { tabIndex: 0, role: "menuitem", "aria-haspopup": !option.isLeaf, "aria-expanded": isActive && !option.isLeaf, "aria-disabled": option.disabled, key: option.value, title: option.label, className: cs(prefixCls + "-list-item", (_a = {},
                        ...
                        React.createElement(Option, { prefixCls: prefixCls, multiple: multiple, option: option, 
                            // 叶子节点被选中
                            selected: !multiple &&
                                option.isLeaf &&
