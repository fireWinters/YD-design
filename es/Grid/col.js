...
function Col(baseProps, ref) {
    ...
    var mergeClassName = (_a = {},
        ...
        _a[prefixCls + "-" + span] = !div && !xs && !sm && !md && !lg && !xl && !xxl,
